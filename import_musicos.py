#!/usr/bin/env python
"""
Script de importacion masiva de musicos - Banda Mejillones
Subir a Render via render.yaml buildCommand o ejecutarlo en el shell de Render.
"""
...
NOMINA = [
    # orden, nombres, apellidos, telefono, ci_raw, instrumento, fecha_nac(YYYY-MM-DD), talla_camisa, numero_calzado
    # TROMPETAS
    ...
    (12,"JHONATAN","POMA","","","TROMPETA","","17","40"),
    ...
    (20,"MUGUELITO","","","","TROMPETA","","15","38"),
    (21,"SGTO. JUAN","POMA","","","TROMPETA","","16","38"),
    ...
    (30,"MILTON","SORUCO","","","TROMPETA","","18","44"),
    ...
    (33,"BERNARDO","PATZI","","","TROMPETA","","17","43"),
    # CLARINETES Y SAXOS
    (1,"PORFIRIO","MAYTA","","","CLARINETE","","16","38"),
    ...
    # BARITONO
    (1,"CRISTIAN","YANARI","","","BARITONO","","15","39"),
    ...
    (14,"LUIS","BELTRAN","","","BARITONO","","15","37"),
    (15,"LUIS","MURGA","","","BARITONO","","15","40"),
    ...
    (20,"JHIMMI","ONTIVEROS","","","BARITONO","","15","39"),
    (21,"BEYMAR","MAMANI","","","BARITONO","","17","39"),
    ...
    (27,"MARCO A.","CALLISAYA","","","BARITONO","","16","40"),
    # TROMBON
    ...
    (4,"ANGEL","GERONIMO","","","TROMBON","","15","38"),
    ...
    (8,"LIMBER","CONDORSET","","","TROMBON","","16","40"),
    ...
    (7,"CESAR ALIAGA","NUEVO","","","PLATILLOS","","15","39"),
    (8,"DEIMAR MAMANI","NUEVO","","","PLATILLOS","","15","39"),
    (9,"EDUARDO","POMA","","","PLATILLOS","","15","39"),
]


def limpiar_ci(ci_raw):
    return re.sub(r'[^0-9]', '', ci_raw.strip())
...
if __name__ == "__main__":
    print("Importando nomina - Banda Mejillones...")
    print("=" * 55)
    importar()
